...
<div class="max-w-6xl mx-auto bg-white p-6 rounded shadow">
    ...
    <table class="table-auto w-full bg-gray-100 rounded">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4" class="text-center py-4">No hay categorias para mostrar!</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="mt-4">
        <a href="{{ route('categories.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Regresar</a>
    </div>
</div>
...
<script>
    function confirmDelete(categoryId) {
        Swal.fire({
            title: 'Estas seguro?',
            text: "Esto lo eliminara para siempre",
            icon: 'warning',
