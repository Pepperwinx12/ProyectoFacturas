...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    <h1 class="text-2xl font-bold mb-4">Crear proveedores</h1>
    ...
    <form action="{{ route('suppliers.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <div class="flex space-x-4">
                <label><input type="radio" name="status" value="1" checked> Activo</label>
                <label><input type="radio" name="status" value="0"> Inactivo</label>
            </div>
        </div>
